...
DClusterReviewPage::DClusterReviewPage(QWidget *parent, DClusterJoinNotify& info)
    : BasePage(parent)
    , curNotifyInfo(info)
{
...
void DClusterReviewPage::initializeWidget()
{
    //导航栏
...
void DClusterReviewPage::fetchData(InputPacket &inpack)
{
    ...
    switch(cmdCode){
        ...
        case CommandCode::DCLUSTER_APPLY_APPROVAL:
            ...
            if(cmdCode == CommandCode::DCLUSTER_INVITE_APPROVAL)
                type = Mi::ClusterInviteReq;
            else if(cmdCode == CommandCode::DCLUSTER_APPLY_APPROVAL)
...
void DClusterReviewPage::on_btnPrePage_clicked()
{
    this->hide();
    this->deleteLater();
}

void DClusterReviewPage::hasCheckedDisplay(Mi::MsgStatus status, Mi::ClusterJoin type)
{
    QString strText;
...
void DClusterReviewPage::on_btnSender_clicked()
{
    //////////////////////////////////////////////
}

void DClusterReviewPage::on_btnAgree_clicked()
{
...
void DClusterReviewPage::on_btnRefuse_clicked()
{
...
void DClusterReviewPage::sendCheckedStatus(quint8 ansCode)
{
...
DClusterReviewPage::~DClusterReviewPage()
{
